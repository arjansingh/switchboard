...
var tools = []mcp.ToolDefinition{
	...
	{
		Name: "linear_create_issue", Description: "Create a new issue. Requires team_id — use list_teams to find it. Use list_workflow_states to discover valid state names.",
